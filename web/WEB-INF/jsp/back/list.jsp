...
<%--使用JSTL结合EL表达式的方式，下面是引入JSTL（标准标签库）--%>
						...
						<table class="tab2" width="100%">
							<tbody>
                                ...
                                <c:forEach items="${messageList}" var="message" varStatus="status">
                                    <tr <c:if test="S{status.index%2 != 0}"> style="background-color:#ECF6EE;"</c:if >>
								<tr>
									...
									<td>
										<a href="#">修改</a>&nbsp;&nbsp;&nbsp;
										<a href="${bathPath}DeleteOneServlet.action?id=${message.id}" >删除</a>
									</td>
								</tr>
                                </c:forEach>
							</tbody>
